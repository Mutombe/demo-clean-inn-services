...
const siteData = {
  business: {
    name: "Clean Inn Services",
    legalName: "Clean Inn Services",
    tagline: "Professional Cleaning & Pest Control Solutions",
    description: "Clean Inn Services was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
    phone: "+263 77 357 8088",
    phoneRaw: "+263773578088",
    whatsappNumber: "263773578088",
    email: "info@cleaninnservices.co.zw",
    address: "58 Cork Rd, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "clean-inn-services-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Clean", logoLine2: "Inn Services" },

  hero: {
    badge: "Professional Cleaning & Pest Control in Harare",
    titleParts: [
      { text: "PRISTINE " },
      { text: "SPACES", highlight: true },
      { text: " EVERY TIME." },
    ],
    ...
    backgroundImages: [
      { url: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1920&q=80", alt: "Professional workspace and equipment" },
      { url: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1920&q=85", alt: "Team delivering quality service" },
      { url: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1920&q=80", alt: "Modern facilities and operations" },
    ],
  },
  ...
  services: {
    ...
    items: [
      { title: "Deep House Cleaning", slug: "deep-cleaning", desc: "A thorough top-to-bottom clean that reaches every corner, crevice, and surface. We leave your home not just clean, but deeply refreshed.", features: ["All-Room Deep Clean", "Kitchen Degreasing", "Bathroom Sanitisation", "Window Cleaning", "Skirting & Fixtures", "Eco-Friendly Products"], image: "https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80" },
  ...
  projects: {
    ...
    items: [
      { title: "Corporate Office Deep Clean", slug: "corporate-deep-clean", category: "Commercial", location: "Harare, Zimbabwe", desc: "Complete deep cleaning of a 3-floor corporate headquarters over one weekend.", client: "Client Project", services: ["Deep House Cleaning", "Pest Control"], image: "https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80", images: ["https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80"] },
      ...
      { title: "Warehouse Fumigation", slug: "warehouse-fumigation", category: "Industrial", location: "Harare, Zimbabwe", desc: "Large-scale fumigation of a 2000sqm food storage warehouse.", client: "Client Project", services: ["Deep House Cleaning", "Pest Control"], image: "https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80", images: ["https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80"] },
      { title: "School Sanitisation Program", slug: "school-sanitisation", category: "Institutional", location: "Harare, Zimbabwe", desc: "Quarterly sanitisation program for a 600-student private school.", client: "Client Project", services: ["Deep House Cleaning", "Pest Control"], image: "https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80", images: ["https://images.unsplash.com/photo-1628177142898-93e36e4e3a50?auto=format&fit=crop&w=1920&q=80"] },
  ...
  homeTestimonials: [
    { text: "Clean Inn Services transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "We had a serious cockroach problem. Clean Inn Services came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Professional, punctual, and incredibly thorough. Clean Inn Services handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Clean Inn Services was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
  ...
  reviews: {
    ...
    items: [
      { text: "Clean Inn Services transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5 },
      { text: "We had a serious cockroach problem. Clean Inn Services came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "Professional, punctual, and incredibly thorough. Clean Inn Services handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Clean Inn Services exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Clean Inn Services to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Clean Inn Services is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Clean Inn Services has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Clean Inn Services! I would like to request a quote.",
    backgroundImage: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1920&q=80",
  },
